                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="capture-progress mt-3">
                                    ...
                                    <div class="progress mb-2">
                                        <div id="faceProgress" class="progress-bar" role="progressbar" style="width: 0%"></div>
                                    </div>
                        ...
                        <div class="row g-3 justify-content-center">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="fingerprint-progress">
                                    <h6>Progreso del Enrolamiento</h6>
                                    <div class="progress mb-2">
                                        <div id="fingerprintProgress" class="progress-bar" role="progressbar" style="width: 0%"></div>
                                    </div>
...
<!-- Estilos movidos al archivo CSS principal -->
