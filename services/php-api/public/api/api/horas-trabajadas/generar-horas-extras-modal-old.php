...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $totalProcesadas = $horasExtrasGeneradas + $horasExtrasExistentes;

        $mensaje = "✅ Generación de horas extras completada.\n\n";
        $mensaje .= "📊 Resumen del proceso:\n";
        $mensaje .= "• Total de horas extras procesadas: {$totalProcesadas}\n";
        $mensaje .= "• ✅ Nuevas insertadas en BD: {$horasExtrasGeneradas}\n";
        $mensaje .= "• ℹ️ Ya existían (evitadas duplicados): {$horasExtrasExistentes}\n\n";
        $mensaje .= "💡 Las nuevas horas extras están pendientes de aprobación.";
