...
require_once __DIR__ . '/../../config/timezone.php';
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        // POST request with multiple employees
...
try {
    ...
    if ($multipleEmployees) {
        ...
        // Respuesta para múltiples empleados
        echo json_encode([
            'periodo' => [
                'fecha_inicio' => $fecha_inicio,
                'fecha_fin' => $fecha_fin
            ],
            'estadisticas_agregadas' => $estadisticasAgregadas,
...
/**
 * Procesa los datos de un empleado individual
 */
